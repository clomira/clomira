        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between py-2">
            ...
            <div className="hidden sm:flex sm:items-center">
              ...
              <a
                href="/profile"
                className="text-gray-800 ml-2 text-sm font-semibold border px-4 py-2 rounded-lg hover:text-purple-600 hover:border-purple-600"
              >
                Profile
              </a>
            </div>
          ...
          <div className="block sm:hidden bg-white border-t-2 py-2">
            <div className="flex flex-col">
              ...
              <div className="flex justify-between items-center border-t-2 pt-2">
                ...
                <a
                  href="/profile"
                  className="text-gray-800 ml-1 text-sm font-semibold border px-4 py-1 rounded-lg hover:text-purple-600 hover:border-purple-600"
                >
                  Profile
                </a>
              </div>
