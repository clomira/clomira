const Doubts = () => {
  return (
    <div className="mt-10">
      <div className="containter mb-10 flex justify-content align-center flex-wrap mx-auto px-10">
        ...
        <div className="bg-white w-7/12 p-8 rounded-lg shadow-lg relative hover:shadow-2xl transition duration-500">
          ...
          <p className="text-gray-600 leading-6 tracking-normal">
            ...
            labore ut, quisquam unde ducimus dolorum. Voluptates, dolore! Magni
            velit nihil recusandae itaque quae vitae delectus cupiditate? Ipsum
            enim minima inventore praesentium dolores nobis corrupti earum,
            laboriosam nesciunt tenetur eveniet libero expedita voluptas illo
            voluptate saepe maxime consectetur nam numquam ratione dolore est
            ipsa. Quia suscipit unde fuga quidem voluptates id laboriosam neque
            velit dicta reiciendis molestias ipsum impedit optio, est amet
            maiores itaque harum autem, minima tenetur deleniti alias nisi
            nulla. Temporibus recusandae placeat voluptatum expedita incidunt
            laboriosam ex tenetur quasi ipsum. Expedita, praesentium illo
            accusamus in cumque ipsam odio nostrum. Consectetur maiores iure
            facere natus eaque ad. Eum nihil placeat provident nemo totam
            quidem, voluptatibus et dolorum magnam nostrum voluptatem quos
      ...
      {/* comments section   */}
      <section className="relative flex items-center justify-center antialiased bg-white mt-20 min-w-screen">
